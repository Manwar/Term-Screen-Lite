...
$Term::Screen::Lite::Generic::VERSION = '0.02';

=head1 NAME

Term::Screen::Lite::Generic - Unix/Linux platform interface to terminal screen.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Term::Screen::Lite::Generic
...
1; # End of Term::Screen::Lite::Generic
